# KAAVAL Local Build & Release Automation Script
# Builds release APK, creates ZIP, and syncs assets with GitHub Releases and Firebase Hosting.

$ErrorActionPreference = "Stop"
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "KAAVAL — Automated Build & Release Sync" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
...
# 4. Deploy Firebase Hosting & Rules
...
Write-Host "`n✓ All releases, APK downloads, and Firebase hosting are up-to-date and live!" -ForegroundColor Green
